...
public class Consolidate {
	...
	String item_numberG = "org_item";  //Org_testcase2,Org_testcase3
	
	public void ReadFile(){
		  File file = new File("D:/SeleniumTest/Selie/configs/Con1.properties");
	 ...
	 public void AdvncSearch()
	 {
		 try
		 {
			...
			//click to navigator icon
				driver.findElement(By.xpath(prop.getProperty("navigator"))).click();  
				TimeUnit.SECONDS.sleep(20); 
...
button.click();
TimeUnit.SECONDS.sleep(10); // drop down list got clicked
...
option1.click();
TimeUnit.SECONDS.sleep(10);//  selected org
...
search.click();
TimeUnit.SECONDS.sleep(10); // searching the item name 
...
search1.click();
TimeUnit.SECONDS.sleep(10); // searches the item name 
...
select.click();
TimeUnit.SECONDS.sleep(10); // select the result
...
WebElement yes = driver.findElement(By.xpath(".//*[@id='_FOpt1:MAyes']"));
yes.click(); 
}
	catch(Exception e){
		e.printStackTrace();
...
public void CrossRef()
{
	...
	WebElement searchclick= driver.findElement(By.id("_FOpt1:_FOr1:0:_FOSritemNode_product_management_items:0:_FOTRaTj_id_1:1:dynam1:0:qq1::search_icon"));
		...
		driver.findElement(By.xpath(".//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_product_management_items:0:MAt2:0:pt1:ap1:sXrefs:1:ItemXrefResultsApp:inputText4::content']")).sendKeys("itmname");
		TimeUnit.SECONDS.sleep(5);
		

		driver.findElement(By.xpath(".//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_product_management_items:0:MAt2:0:pt1:ap1:sXrefs:1:ItemXrefResultsApp:inputText5::content']")).sendKeys("itmname");
		TimeUnit.SECONDS.sleep(5);
...
driver.findElement(By.xpath(".//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_product_management_items:0:_FOTRaTj_id_1:1:dynam1:0:qq1:inputTextQuickSearch1::content']")).sendKeys(prop.getProperty("itemname1"));
TimeUnit.SECONDS.sleep(10);

WebElement clicksearch= driver.findElement(By.id("pt1:_FOr1:0:_FOSritemNode_product_management_items:0:_FOTRaTj_id_1:1:dynam1:0:qq1::search_icon"));
clicksearch.click();
TimeUnit.SECONDS.sleep(10);
...
driver.findElement(By.xpath(".//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_product_management_items:0:MAt2:0:pt1:ap1:sRelFl:1:RelatedItemResults:ip2:Popup1:0:Advan1:0:efqrp:value00::content']")).sendKeys(prop.getProperty("itemname2"));
